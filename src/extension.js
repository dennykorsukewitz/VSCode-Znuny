...
function updateStatusBarItem() {
    ...
    console.log('znunyData !!!');
    console.log(znunyData);
    // console.log(config);

    if (znunyData.origin && znunyData.commitid && znunyData.source) {

        console.log('PAAARTy')
        console.log(znunyData)
        console.log(znunyData.origin)

    }
    else if  (znunyData.product && znunyData.version && znunyData.source) {
